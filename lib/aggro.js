...
const midCanvasWidth = 2560
const midCanvasHeight = 1440
const maxCanvasWidth = 5120
const maxCanvasHeight = 2880
...
function resizeCanvas () {
  ...
  } else if (player.width < 400 && canvas.width !== defaultCanvasWidth) {
