...
/* harmony import */ var _dom_elements__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dom_elements */ "./lib/dom_elements.js");
/* harmony import */ var _time_calculation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./time_calculation */ "./lib/time_calculation.js");
...
function updateGems () {
  let level = Math.floor(_time_calculation__WEBPACK_IMPORTED_MODULE_3__["time"] / 60)
...
function endGame () {
  if (player.width < 1) {
    ...
    endGameText = `you have starved to death, you survived for ${_time_calculation__WEBPACK_IMPORTED_MODULE_3__["currentTime"]}`
    firebase.database().ref('scores').push({name: player.name, score: _time_calculation__WEBPACK_IMPORTED_MODULE_3__["time"]})
    gemsArray = []
    return endGameText
  } else {
    return null
...
function resizeCanvas () {
  if (player.width > 400 && player.width < 700 && _dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].width !== midCanvasWidth) {
    _dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].height = midCanvasHeight
    _dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].width = midCanvasWidth
  } else if (player.width > 700 && _dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].width !== maxCanvasWidth) {
    _dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].height = maxCanvasHeight
    _dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].width = maxCanvasWidth
  } else if (player.width < 350 && _dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].width !== defaultCanvasWidth) {
    _dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].height = defaultCanvasHeight
    _dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].width = defaultCanvasWidth
  } else {
    return null
  }
}
...
function renderScores () {
  ...
  scores.forEach((el) => {
    ...
    _dom_elements__WEBPACK_IMPORTED_MODULE_2__["context"].font = '15px Arial'
    _dom_elements__WEBPACK_IMPORTED_MODULE_2__["context"].fillStyle = '#fff'
    _dom_elements__WEBPACK_IMPORTED_MODULE_2__["context"].fillText(rendered, 20, pos)
  })
}

function animate () {
  _dom_elements__WEBPACK_IMPORTED_MODULE_2__["context"].clearRect(player.x - _dom_elements__WEBPACK_IMPORTED_MODULE_2__["camera"].pos.x - (_dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].width / 2) - 5, player.y - _dom_elements__WEBPACK_IMPORTED_MODULE_2__["camera"].pos.y - (_dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].height / 2) - 5, _dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].width + 10, _dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].height + 10)
  if (endGame()) {
    ...
    resizeCanvas()
    _dom_elements__WEBPACK_IMPORTED_MODULE_2__["context"].fillStyle = 'transparent'
    _dom_elements__WEBPACK_IMPORTED_MODULE_2__["context"].fillRect(0, 0, _dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].width, _dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].height)
    updateGems()
    _dom_elements__WEBPACK_IMPORTED_MODULE_2__["camera"].updatePos()
    player.move()
    player.draw()
    Object(_time_calculation__WEBPACK_IMPORTED_MODULE_3__["tick"])()
    timer.innerText = `${_time_calculation__WEBPACK_IMPORTED_MODULE_3__["currentTime"]}`
...
function handleStart () {
  Object(_time_calculation__WEBPACK_IMPORTED_MODULE_3__["startTime"])()
...
startButton.addEventListener('click', handleStart)
_dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].addEventListener('mousemove',
  (e) => {
    _dom_elements__WEBPACK_IMPORTED_MODULE_2__["mousePos"].x = e.clientX - _dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].offsetLeft - 160
    _dom_elements__WEBPACK_IMPORTED_MODULE_2__["mousePos"].y = e.clientY - _dom_elements__WEBPACK_IMPORTED_MODULE_2__["canvas"].offsetTop - 83
  })
